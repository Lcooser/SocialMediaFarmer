...
namespace SocialMediaFarmer.Controllers
{
    public class RespostasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Conteudo,PerguntaId,UsuarioId")] Resposta resposta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Conteudo,PerguntaId,UsuarioId")] Resposta resposta)
        {
            if (id != resposta.Id)
            {
                return NotFound();
